      ...
      <div className="py-20 max-w-[700px] mx-auto">
       <div className="flex items-center justify-between">
        <h2 className="font-bold text-5xl text-black dark:text-[#f0f2f8]">
            ...
            <a className="underline block" href="https://webscout.vercel.app">Visit Webscout</a>
       </div>
       <h3 className="text-2xl font-medium text-black dark:text-[#f0f2f8] py-6">
        ...
        <div className="flex gap-2">
          <div className="flex-1 min-h-full">
            <img src={Webscouthome.src} alt="minlinks-homepage" className="hover:scale-150  rounded-sm" />
          </div>
          <div className="flex flex-col flex-1 gap-2">
            <img src={WebscoutDash.src} alt="minlinks-homepage" className="hover:scale-150 rounded-sm"/>
            <img src={WebscoutForm.src} alt="minlinks-homepage" className="hover:scale-150 rounded-sm" />
          </div>
